...
class JournalEntryFormMobile extends StatefulWidget {
  const JournalEntryFormMobile({super.key});

  @override
  State<JournalEntryFormMobile> createState() => _JournalEntryFormMobileState();
}

class _JournalEntryFormMobileState extends State<JournalEntryFormMobile> {

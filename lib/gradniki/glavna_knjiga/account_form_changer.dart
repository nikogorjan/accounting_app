...
class AccountFormChanger extends StatefulWidget {
  const AccountFormChanger(
      {super.key,
      required this.ID,
      required this.tip,
  ...
  @override
  State<AccountFormChanger> createState() => _AccountFormChangerState();
}

class _AccountFormChangerState extends State<AccountFormChanger> {
  ...
  void initState() {
    ...
    _amortizacijaController.text = widget.amortizacija;

...
class DelavciDnevnik extends StatefulWidget {
  const DelavciDnevnik({super.key});

  @override
  State<DelavciDnevnik> createState() => _DelavciDnevnikState();
}

class _DelavciDnevnikState extends State<DelavciDnevnik> {

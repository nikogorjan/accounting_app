...
class AddProjektForm extends StatefulWidget {
  const AddProjektForm({super.key});

  @override
  State<AddProjektForm> createState() => _AddProjektFormState();
}

class _AddProjektFormState extends State<AddProjektForm> {
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        docRef.get().then((DocumentSnapshot doc) {
                          ...
                          projektiJson.add(jsonEncode(pro));
                          FirebaseFirestore.instance
                              .collection('Users')
                              .doc(ID)
                              .update({'projekti': projektiJson});
                        });
                        //dodaj projekt
                      },
                      child: Text('Dodaj'),

...
class ProjektCard extends StatefulWidget {
  const ProjektCard({super.key, required this.projekt});
  final Projekt projekt;

  @override
  State<ProjektCard> createState() => _ProjektCardState();
}

class _ProjektCardState extends State<ProjektCard> {

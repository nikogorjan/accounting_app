...
class StrankeRow extends StatefulWidget {
  const StrankeRow({super.key, required this.stranka});
  final Stranka stranka;

  @override
  State<StrankeRow> createState() => _StrankeRowState();
}

class _StrankeRowState extends State<StrankeRow> {
        ...
        onTap: () {
          showDialog(
              ...
              builder: (BuildContext context) {
                return AlertDialog(
                    content: StrankaFormChanger(stranka: widget.stranka));
              });
        },
        child: MouseRegion(

...
import 'package:accounting_app/api/pdf_invoice_api.dart';
import 'package:accounting_app/gradniki/prodaja/vnos_v_racun_prodaja.dart';
import 'package:accounting_app/objekti/invoice.dart';
...
class ProdajaDodajRacun extends StatefulWidget {
  const ProdajaDodajRacun({super.key});

  @override
  State<ProdajaDodajRacun> createState() => _ProdajaDodajRacunState();
}
...
class _ProdajaDodajRacunState extends State<ProdajaDodajRacun> {
  ...
  List<VnosVRacunProdaja> _children = [];

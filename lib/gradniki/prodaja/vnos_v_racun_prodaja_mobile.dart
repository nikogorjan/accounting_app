...
class VnosVRacunProdajaMobile extends StatefulWidget {
  const VnosVRacunProdajaMobile(
  ...
  final Function(int, String, String, String, String, String, String, String)
      onFormSubmitted;
  @override
  State<VnosVRacunProdajaMobile> createState() =>
      _VnosVRacunProdajaMobileState();
}

class _VnosVRacunProdajaMobileState extends State<VnosVRacunProdajaMobile> {
                      ...
                      builder: (BuildContext context,
                        ...
                        return ListView(
                          ...
                          children: snapshot.data!.docs
                            ...
                            List<dynamic> predmetiJson =
                                data['produkti in storitve'];
                            ...
                            if (val2changed == false) {
                              ...
                              int ii = predmeti.indexWhere(
                                  (element) => element.naziv == value2);
                              tip = predmeti[ii].PS;
                            }

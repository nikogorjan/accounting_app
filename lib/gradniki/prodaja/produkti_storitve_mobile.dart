...
import 'package:accounting_app/gradniki/prodaja/produkt_storitev_row_mobile.dart';
...
class ProduktiStoritveMobile extends StatefulWidget {
  const ProduktiStoritveMobile({super.key});

  @override
  State<ProduktiStoritveMobile> createState() => _ProduktiStoritveMobileState();
}

class _ProduktiStoritveMobileState extends State<ProduktiStoritveMobile> {
                    ...
                    return Column(
                      children: [
                        for (int i = 0; i < accounts.length; i++) ...[
                          ProduktStoritevRowMobile(
                              produktStoritev: accounts[i]),
                          Divider(
                            height: 1,
                          )
                        ],
